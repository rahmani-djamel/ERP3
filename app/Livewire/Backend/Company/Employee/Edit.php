...
class Edit extends Component
{
    ...
    public function rules()
    {
        return [
            ...
            'OtherAllowances' => 'required|numeric',
            'InsuranceRatio' => 'required|numeric',
            'InsuranceSubscriptionAmount' => 'required|string|max:255',
            'HousingAllowance' => 'required|numeric',
            'transportationAllowance' => 'required|numeric',
            'VacationSalary' => 'required|numeric',
            'DurationOfTheWarningPeriod' => 'required|numeric|max:255',
