<main>
    <div>
            ...
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12 shadow-2xl ">
             ...
             <form class="pt-3">
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <x-input wire:model="Name_English" right-icon="user" label="{{__('Company owner')}}"  />
                    </div>
            </div>
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-6 group">
                    <x-input type="number" wire:model="price" right-icon="device-mobile" label="{{__('Phone')}}"  />
                </div>
                <div class="relative z-0 w-full mb-6 group">
                    <x-input type="number" wire:model="days" right-icon="at-symbol" label="{{__('Email')}}"  />
                </div>
           </div>
           <div class="grid md:grid-cols-2 md:gap-6">
            <div class="relative z-0 w-full mb-6 group">
       ...
       <div class="grid md:grid-cols-2 md:gap-6"  x-data="{ open: @entangle('is_trial') }">
        ...
        <div class="relative z-0 w-full mb-6 group">
            <x-input type="number" wire:model="N_Branches" right-icon="adjustments" label="{{__('Days')}}"  />
        </div>
