                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    <div class="flex items-center justify-between d p-4">
                        <div class="flex">
                            ...
                            target="_blank"
                            label="رجوع الى اوقات عمل الموظفين"
                            teal
                        />
                        </div>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 ">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:text-white dark:bg-gray-700">
                                <tr>
                                    <!-- __BLOCK__ -->                            
                                    <th scope="col" class="px-4 py-3 text-center"> الأسبوع</th>
                            
                                                                
                                    <th scope="col" class="px-4 py-3 text-center">وقت البداية</th>
                            
                                                                
                                    <th scope="col" class="px-4 py-3 text-center">وقت النهاية</th>
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                     تعديل التوقيت الخاص بيوم <span class="text-sky-500 font-medium">{{$selected['weekday'] ??''}}</span>
                </h3>
            </div>
            <!-- Modal body -->
