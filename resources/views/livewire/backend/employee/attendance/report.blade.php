        ...
        <section class="pt-10">
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                     <x-employee.includes.header-card iconname="document-report" title="{{__('Read report')}}" />
                                    ...
                                    <table class="w-full text-sm text-left text-gray-500 ">
                                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:text-white dark:bg-gray-700" >
                                            <tr>
                                                ...
                                                <th scope="col" class="px-4 py-3 text-center">{{__('Delay')}}</th>
                                                <th scope="col" class="px-4 py-3 text-center">{{__('Leave')}}</th>
                                                 ...
                                                 <tbody>
                                                    ...
                                                    @forelse ($attendances as $cle => $item)
